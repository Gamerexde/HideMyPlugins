...
public final class HideMyPlugins extends JavaPlugin implements Listener {
    ...
    public List<String> getAdminTableHeaderArray() {
        return new ArrayList<String>(getMsgConfig().getStringList("admin.history_table_header"));
    }
        ...
        ProtocolLibrary.getProtocolManager().addPacketListener((PacketListener)new PacketAdapter(this, new PacketType[] { PacketType.Play.Client.TAB_COMPLETE }) {
            ...
            public void onPacketReceiving(final PacketEvent event) {
                if (event.getPacketType() == PacketType.Play.Client.TAB_COMPLETE) {
                    ...
                    final String messgae = ((String)pc.getSpecificModifier((Class)String.class).read(0)).toLowerCase();
                    if (event.getPlayer().hasPermission("hidemyplugins.access")) {
                        ...
                        if (blockedCommands.stream().anyMatch(command -> messgae.startsWith("/" + command.toLowerCase()))) {
